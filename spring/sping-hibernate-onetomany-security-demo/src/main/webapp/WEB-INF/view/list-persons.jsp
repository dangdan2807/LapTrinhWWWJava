...
<body>
	<div class="container">
		...
		<c:url
			var="viewImgUrl"
			value="/resources/img/eye.png"
		/>
		<c:url
			var="addUrl"
			value="/person/showFormForAdd"
		/>
		<div class="col-md-12">
			<nav class="nav">
			...
			<security:authorize access="hasAnyRole('EMPLOYEE','MANAGER', 'ADMIN')">
				<span> User: <security:authentication property="principal.username" />,
			...
			<table class="table table-striped">
				...
				<thead style="background: #CC99FF">
					<tr>
						...
						<th>Số tiền</th>
						<security:authorize access="hasAnyRole('MANAGER', 'ADMIN')">
							<th style="width: 130px; text-align: center;">Sửa</th>
						</security:authorize>
						<security:authorize access="hasAnyRole('ADMIN')">
							<th style="width: 130px; text-align: center;">Xóa</th>
						</security:authorize>
						<th style="width: 130px; text-align: center;">Xem
							thẻ tín dụng</th>
						<!--<th colspan="3"></th>-->
					</tr>
				</thead>
				<tbody>
					...
					>
						<c:url
							var="editUrl"
							value="/person/showFormForUpdate"
						>
							<c:param
								name="personId"
								value="${person.id}"
						...
						<tr>
							...
							<security:authorize access="hasAnyRole('ADMIN')">
								<td style="border-radius: 50px; text-align: center;"><a
									href="${deleteUrl}"
									class="btnTable"
								><img src="${deleteImgUrl}" /></a></td>
							</security:authorize>
							<td style="border-radius: 50px; text-align: center;"><a
								href="${viewUrl}"
								class="btnTable"
							><img src="${viewImgUrl}" /></a></td>
						</tr>
